<template>
    <div class="profile">
        <Quote size="small">
            Заполните пожалуйста профиль. Все эти данные будет видеть заказчик в своей таблице. 
            Когда будет выбирать фрилансера ему нужно точно понять подходите ли вы.
        </Quote>
        <AccountCard />
